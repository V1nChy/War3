...
int DInput_Init_Mouse(void);//鼠标
int DInput_Init_Keyboard(void);//键盘
int DInput_Init_Joystick(int min_x=-256, int max_x=256,int min_y=-256, int max_y=256, int dead_band = 10);//操作杆
